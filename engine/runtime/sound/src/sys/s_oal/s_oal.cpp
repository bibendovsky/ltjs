...
struct OalSoundSys::Impl
{
		...
		const sint32 value)
	{
		...
		sample.set_user_value(index, value);
	}
		...
		const uint32 index)
	{
		...
		return sample.get_user_value(index);
	}
