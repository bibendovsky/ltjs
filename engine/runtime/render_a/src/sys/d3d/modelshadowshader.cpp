...
bool CModelShadowShader::SetWorldTransform(const LTMatrix& mInvWorldTrans)
{
	...
	const ltjs::cgm::Mat4 mD3DInvTrans{
	...
	ltjs::cgm::Mat4 mResult;

	mResult = mD3DInvTrans * m_mWorldToProjector;
