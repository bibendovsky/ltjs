...
CDibPal::InitPal(const char* sFile, DWORD flags)
{
...
CDibPal::InitPcx(const char* sFile, DWORD flags)
{
	// Open the file...
...
CDibPal::InitBmp(const char* sFile, DWORD flags)
{
	// Open the file...
...
CDibPal::InitRes(const char* sFile, DWORD flags)
{
	// Sanity checks... 
